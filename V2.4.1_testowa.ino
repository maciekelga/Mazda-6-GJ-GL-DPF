...
DEBUG_PORT.println("CASE 5");
      ...
      if (count2 <= 2) //dioda led miga 4 razy co 1 sekunde gdy nie uda sie polaczyc z interfejsem
        {
...
DEBUG_PORT.println(PM_ACC_calc_avg);
        ...
        if (count2 > 2)
        {
        DPF_LRD_calc_avg = DPF_LRD_calc_avg / 3;
        PM_GEN_calc_avg = PM_GEN_calc_avg / 3;
        PM_ACC_calc_avg = PM_ACC_calc_avg / 3; 
        mode_number = 6;
