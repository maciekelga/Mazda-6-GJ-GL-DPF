...
case 5:
      ...
      else if (((PM_GEN_calc) >=0.3) && ((PM_GEN_calc) < 0.93)))
      {
        ...
        analogWrite(LED8, 0); 
        analogWrite(LED9, 0);
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S1 == FALSE)
		{
		delay(500);
		analogWrite(LED1, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S2 == FALSE)
		{
		delay(500);
		analogWrite(LED2, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S3 == FALSE)
		{
		delay(500);
		analogWrite(LED3, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S4 == FALSE)
		{
		delay(500);
		analogWrite(LED4, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S5 == FALSE)
		{
		delay(500);
		analogWrite(LED5, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S6 == FALSE)
		{
		delay(500);
		analogWrite(LED6, 0);
		delay(500);
	...
	if ((PM_ACC_calc - PM_GEN_calc) > 2 && (DPF_Regen == 0) && S7 == FALSE)
		{
		delay(500);
		analogWrite(LED7, 0);
		delay(500);
      ...
      else if (((PM_GEN_calc) >=4.71) && ((PM_GEN_calc) < 5.34)))
      {
        ...
        analogWrite(LED8, 50);  
        analogWrite(LED9, 0);
	if ((PM_ACC_calc - PM_GEN_calc) > 1.5 && (DPF_Regen == 0) && S8 == FALSE)
		{
		delay(500);
		analogWrite(LED8, 0);
		delay(500);
      ...
      else if ((PM_GEN_calc) >=5.34))
      {
        ...
        analogWrite(LED8, 50); 
        analogWrite(LED9, 50); 
	if ((PM_ACC_calc - PM_GEN_calc) > 1.5 && (DPF_Regen == 0) && S9 == FALSE)
		{
		delay(500);
		analogWrite(LED9, 0);
		delay(500);
