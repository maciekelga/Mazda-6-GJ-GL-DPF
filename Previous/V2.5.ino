...
int PWM_value_g = 0; //zmienna wypelnienia wyjsc LED zielonych
int PWM_value_orb = 0; //zmienna wypelnienia wyjsc LED pomaranczowych, czerwonych i niebieskiej
...
DEBUG_PORT.println("CASE 5");
      ...
      if (currentMillis - previousMillis2 >= 300) //czesc programu ktora jest wykonywana z 500ms opoznieniem po otrzymaniu wszystkich 4 odczytow. W tej czesci kodu nastepuje eliminacja blednych pojedynczych odczytow.
        {
...
void illumination()
{
  DEBUG_PORT.println("PODSWIETLENIE");
    ill_in_state = digitalRead(ILL_IN);
    if (ill_in_state == true)
    {
      DEBUG_PORT.println("PODSWIETLENIE h");
      PWM_value_g = 18000;
      PWM_value_orb = 45000;
      if (S20 == false)
        {
     ...
     {
      DEBUG_PORT.println("PODSWIETLENIE l");
      PWM_value_g = 25;
      PWM_value_orb = 75;
      if (S21 == false)
        {
